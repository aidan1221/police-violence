...
killings_per_1000000.loc[:, "# Black people killed"] = (
        (police_violence_df.loc[:50, "# Black people killed"] / police_violence_df.loc[:50, "African-American Alone"])
        * 1000000)
...
fig2 = go.Figure(data=go.Scatter(x=killings_per_1000000["Black_population"],
                                 ...
                                 mode='markers',
                                 marker=dict(
                                     size=(killings_per_1000000["# Black people killed per 1000000 Black people"] / 5)),
